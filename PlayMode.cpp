...
Load< Scene > phonebank_scene(LoadTagDefault, []() -> Scene const * {
	return new Scene(data_path("four-color.scene"), [&](Scene &scene, Scene::Transform *transform, std::string const &mesh_name){
...
Load< WalkMeshes > phonebank_walkmeshes(LoadTagDefault, []() -> WalkMeshes const * {
	WalkMeshes *ret = new WalkMeshes(data_path("four-color.w"));
